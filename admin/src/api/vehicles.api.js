...
const updateAvailableVehicle = async (id, availableStatus) => {
...
const updateReturnVehicle = async (id, sucursalId) => {
	const response = await api.patch(`vehiculos/${id}/`, {
		available: true,
		sucursal: sucursalId,
	})
...
const getBySucursalAndCategory = async (sucursalId, categoryId) => {
	const response = await api.get(
		`vehiculos/sucursal/${sucursalId}/categoria/${categoryId}/`
	)
	return response.data
}

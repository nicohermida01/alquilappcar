						...
						<Accordion variant='splitted' selectionMode='multiple'>
							<AccordionItem key='1' aria-label='Vehículos' title='Vehículos'>
								<div className='flex flex-col px-4'>
									...
									<SidebarLink to='/marcas'>Marcas</SidebarLink>
									<SidebarLink to='/categorias'>Categorías</SidebarLink>
									<SidebarLink to='/cancelaciones'>Cancelaciones</SidebarLink>
								</div>
							</AccordionItem>
							<AccordionItem key='2' aria-label='Usuarios' title='Usuarios'>
								<div className='flex flex-col px-4'>
									<SidebarLink to='/empleados'>Empleados</SidebarLink>

...
function HomePage() {
  ...
  return (
    <div
      id="body"
      className="bg-[url(/../commons/obi-aZKJEvydrNM-unsplash.jpg)]"
    >
      <Topbar />
      <div className="gap-4" style={{ width: "60%" }}>
        <h1 className="font-bold text-left" style={{ maxWidth: "450px" }}>
          Maneja tu camino con nostros
        </h1>
        <Card className="bg-background/60" isBlurred>
          <CardBody className="gap-4 p-10">
            <h2 className="font-bold text-xl">¡Alquila tu vehículo ya!</h2>
            <Form
